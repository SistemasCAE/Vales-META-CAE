	...
	cargarRestaurantes : function(){
		...
		$.getJSON(url, { 
			...
			for(var x=0; x<tamano; x++)
			{
				...
				tablaGenerada +="<div class='resultadoRestaurantes'><div class='A' id='map-canvas'"+x+"></div><div class='B'><div>"+data[x]['NOMBRE']+"</div><div>"+data[x]['DIRECCION']+"</div><div>"+data[x]['TELEFONO']+"</div></div></div>";
